...
angular.module('openWeatherApp.services', ['ngResource'])
  ...
  //
  .value('exampleLocations',['Nikopol','Berlin','Paris','London','Tokyo','New York','Minsk','Kyiv'])
  //
  // Storm "Xaver" special locations
  //
  .value('stormLocations',['Sylt','St. Peter-Ording','Husum','Bremerhaven','Nikopol','Kiel','Lübeck'])
